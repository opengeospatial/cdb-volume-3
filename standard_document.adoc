:Title: Volume 3: OGC CDB Terms and Definitions (Normative)
:titletext: Volume 3: OGC CDB Terms and Definitions (Normative)
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
[width = "50%", grid = "none"]
|===
|Document type:   	Draft OGC® Implementation Standard
|Document subtype:   
...
include::clause_1_termsanddefinitions.adoc[]
